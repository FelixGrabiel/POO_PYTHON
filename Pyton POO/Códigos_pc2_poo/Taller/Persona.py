""" 
! para definir un atributo público solo se pone el nombre ejemplo:  persona (ya es pública)
! Para privada se usa doble guión abajo ejemplo: __nombre (privada)
! Para protegida se usa un guión abajo ejemplo: _nombre (protegida)
! __init__ constructor 
! self objeto actual dentro de una clase
""" 
import random
